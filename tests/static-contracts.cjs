...
assert(/CACHE_NAME\s*=\s*"sophie-app-v2-12-skills-android-stage"/.test(sw), "service-worker cache is not versioned for v2.6 stage");
...
assert(!code.includes("sophie-app-v2-12-skills-android-stage"), "backend unexpectedly modified for frontend cache version");
